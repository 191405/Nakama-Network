...
const Marketplace = () => {
  ...
  /* premium gate logic remains for the actual marketplace interaction, but guest auth is handled by GuestGuard */
  const renderGate = () => {
  ...
  return (
    <GuestGuard feature="marketplace">
      {(!userProfile || !userProfile.isPremium) ? renderGate() : (
